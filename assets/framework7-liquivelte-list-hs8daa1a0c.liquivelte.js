import { SvelteComponent, init, safe_not_equal, empty, insert_hydration, group_outros, transition_out, check_outros, transition_in, detach, compute_rest_props, createEventDispatcher, onMount, onDestroy, assign, exclude_internal_props, compute_slots, binding_callbacks, create_slot, element, space, claim_element, children, claim_space, set_attributes, append_hydration, update_slot_base, get_all_dirty_from_scope, get_slot_changes, get_spread_update, listen } from './liquivelte-svelte-hs532e1aa9.liquivelte.js';
import { createEmitter, setReactiveContext, useTab, f7ready, app, extend, classNames, colorClasses, restProps } from './framework7-liquivelte-hs5d6b599e.liquivelte.js';
