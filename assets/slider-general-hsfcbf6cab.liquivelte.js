import { SvelteComponent, init, safe_not_equal, create_slot, element, claim_element, children, detach, attr, set_style, insert_hydration, update_slot_base, get_all_dirty_from_scope, get_slot_changes, transition_in, transition_out, getContext, assign, exclude_internal_props, space, create_component, claim_space, claim_component, append_hydration, mount_component, group_outros, check_outros, destroy_component, onMount, tick, empty, destroy_each, binding_callbacks } from './liquivelte-svelte-hs75fa7249.liquivelte.js';
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "card svelte-hx1sfp");
			set_style(div, "--left", /*settings*/ ctx[3].card_left + "%");
			set_style(div, "--top", /*settings*/ ctx[3].card_top + "%");
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$new_props => {
		...
		if ('settings' in $$new_props) $$invalidate(3, settings = $$new_props.settings);
		if ('$$scope' in $$new_props) $$invalidate(6, $$scope = $$new_props.$$scope);
	};

	$$props = exclude_internal_props($$props);
	return [left, width, height, settings, importsSeek, top, $$scope, slots];
}
...
function create_fragment$1(ctx) {
	...
	card = new Card({
			props: { settings: /*block*/ ctx[0].settings }
		});
	...
	return {
		...
		l(nodes) {
			...
			claim_component(card.$$.fragment, div1_nodes);
