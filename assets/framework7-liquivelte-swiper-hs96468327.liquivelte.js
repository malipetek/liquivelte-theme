import { SvelteComponent, init, safe_not_equal, create_slot, assign, element, space, claim_element, children, claim_space, detach, attr, set_attributes, toggle_class, insert_hydration, append_hydration, update_slot_base, get_all_dirty_from_scope, get_slot_changes, get_spread_update, transition_in, transition_out, compute_rest_props, getContext, createEventDispatcher, setContext, onMount, afterUpdate, onDestroy, exclude_internal_props, noop, binding_callbacks, tick } from './liquivelte-svelte-hs8b900a8a.liquivelte.js';
import { Swiper, getParams } from './framework7-liquivelte-get-params-hsf7b0a459.liquivelte.js';
import { mountSwiper } from './framework7-liquivelte-mount-swiper-hs2e0ee625.liquivelte.js';
import { extend, needsNavigation, needsScrollbar, needsPagination } from './framework7-liquivelte-utils-hs84a9c325.liquivelte.js';
import { getChangedParams } from './framework7-liquivelte-get-changed-params-hse7431b82.liquivelte.js';
import { updateSwiper } from './framework7-liquivelte-update-swiper-hs2234c08f.liquivelte.js';
