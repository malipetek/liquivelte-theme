...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (default_slot) {
				if (default_slot.p && (!current || dirty[0] & /*$$scope, f7Panel*/ 536870944)) {
					update_slot_base(
						default_slot,
...
function instance_1($$self, $$props, $$invalidate) {
	...
	const omit_props_names = [
		"classes","side","effect","cover","reveal","push","left","right","opened","resizable","backdrop","backdropEl","containerEl","closeByBackdropClick","visibleBreakpoint","collapsedBreakpoint","swipe","swipeNoFollow","swipeOnlyClose","swipeActiveArea","swipeThreshold","f7Slot","instance"
	];
	...
	$$self.$$set = $$new_props => {
		...
		if ('closeByBackdropClick' in $$new_props) $$invalidate(18, closeByBackdropClick = $$new_props.closeByBackdropClick);
		if ('visibleBreakpoint' in $$new_props) $$invalidate(19, visibleBreakpoint = $$new_props.visibleBreakpoint);
		if ('collapsedBreakpoint' in $$new_props) $$invalidate(20, collapsedBreakpoint = $$new_props.collapsedBreakpoint);
		if ('swipe' in $$new_props) $$invalidate(21, swipe = $$new_props.swipe);
		if ('swipeNoFollow' in $$new_props) $$invalidate(22, swipeNoFollow = $$new_props.swipeNoFollow);
		if ('swipeOnlyClose' in $$new_props) $$invalidate(23, swipeOnlyClose = $$new_props.swipeOnlyClose);
		if ('swipeActiveArea' in $$new_props) $$invalidate(24, swipeActiveArea = $$new_props.swipeActiveArea);
		if ('swipeThreshold' in $$new_props) $$invalidate(25, swipeThreshold = $$new_props.swipeThreshold);
