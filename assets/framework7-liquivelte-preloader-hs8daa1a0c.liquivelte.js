...
import { restProps, useTheme, classNames, colorClasses } from './framework7-liquivelte-hsa0091f48.liquivelte.js';
...
function instance($$self, $$props, $$invalidate) {
	let sizeComputed;
	let preloaderStyle;
	const omit_props_names = ["style","classes","size"];
...
class Preloader extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { style: 5, classes: 4, size: 6 });
	}
}
