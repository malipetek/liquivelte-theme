...
function create_fragment(ctx) {
	...
	let i_levels = [
		...
		{
			class: i_class_value = "" + (/*iconClasses*/ ctx[6] + " " + /*classes*/ ctx[0])
		},
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			set_attributes(i, i_data = get_spread_update(i_levels, [
				...
				(!current || dirty & /*iconClasses, classes*/ 65 && i_class_value !== (i_class_value = "" + (/*iconClasses*/ ctx[6] + " " + /*classes*/ ctx[0]))) && { class: i_class_value },
...
function instance($$self, $$props, $$invalidate) {
	...
	const omit_props_names = [
		"lec","style","classes","material","f7","icon","ios","aurora","md","tooltip","tooltipTrigger","size"
	];
