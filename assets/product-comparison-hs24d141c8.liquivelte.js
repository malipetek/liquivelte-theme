...
var outin = /*@__PURE__*/getDefaultExportFromCjs(outin$1);

/* Usersmalipetek/Documents/Documents/Projects/LIQUVELTE/LIQUIVELTE TEST/src/components/LazyComponent.svelte generated by Svelte v3.50.0 */
...
function create_if_block$1(ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			info.ctx = ctx;
			dirty & /*loading*/ 2 && promise !== (promise = /*loading*/ ctx[1]) && handle_promise(promise, info);
		},
		i(local) {
			if (current) return;
...
// (1:0) <!-- filename: LazyComponent.svelte --> <script>  export let when = false;  export let component;  let loading;  $: if (when) {   load();  }
...
// (14:45)    <Component />  {/await}
function create_then_block(ctx) {
	get_then_context(ctx);
	let component_1;
	let current;
	component_1 = new /*Component*/ ctx[4]({});
...
function create_fragment$1(ctx) {
	let if_block_anchor;
	let current;
	let if_block = /*when*/ ctx[0] && create_if_block$1(ctx);
...
function instance$1($$self, $$props, $$invalidate) {
	...
	function load() {
		$$invalidate(1, loading = component());
	}
	...
	return [when, loading, component];
}

class LazyComponent extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { when: 0, component: 2 });
	}
}
...
function get_each_context(ctx, list, i) {
	...
	const constants_0 = {
		...
		last: /*index*/ child_ctx[11] === /*section*/ child_ctx[0].blocks.length - 1,
		rindex: /*section*/ child_ctx[0].blocks.length - /*index*/ child_ctx[11],
		rindex0: /*section*/ child_ctx[0].blocks.length - /*index*/ child_ctx[11] - 1,
...
// (71:6) {#if current_block == forloop.index }
function create_if_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "backplate svelte-fts4kk");
			set_style(div, "background-color", /*block*/ ctx[8].settings.bg_color);
		},
		m(target, anchor) {
...
function create_each_block_2(ctx) {
	let if_block_anchor;
	let current;
	let if_block = /*current_block*/ ctx[1] == /*forloop*/ ctx[9].index && create_if_block_1(ctx);
	...
	return {
		...
		p(ctx, dirty) {
			if (/*current_block*/ ctx[1] == /*forloop*/ ctx[9].index) {
				if (if_block) {
					if_block.p(ctx, dirty);
...
// (88:4) {#if current_block == forloop.index }
function create_if_block(ctx) {
	...
	let div1;
	let span0;
	let t2_value = /*block*/ ctx[8].settings.product_1_param_1_value + "";
	let t2;
	let span0_transition;
	let t3;
	let t4_value = /*block*/ ctx[8].settings.product_1_param_1_unit + "";
	let t4;
	let t5;
	let div2;
	let t6_value = /*block*/ ctx[8].settings.param_1 + "";
	let t6;
	let t7;
	let div6;
	let div4;
	let span1;
	let t8_value = /*block*/ ctx[8].settings.product_1_param_2_value + "";
	let t8;
	let span1_transition;
	let t9;
	let t10_value = /*block*/ ctx[8].settings.product_1_param_2_unit + "";
	let t10;
	let t11;
	let div5;
	let t12_value = /*block*/ ctx[8].settings.param_2 + "";
	let t12;
	let t13;
	let div9;
	let div7;
	let span2;
	let t14_value = /*block*/ ctx[8].settings.product_1_param_3_value + "";
	let t14;
	let span2_transition;
	let t15;
	let t16_value = /*block*/ ctx[8].settings.product_1_param_3_unit + "";
	let t16;
	let t17;
	let div8;
	let t18_value = /*block*/ ctx[8].settings.param_3 + "";
	let t18;
	let t19;
	let div24;
	let div12;
	...
	let div23;
	let div13;
	let t21_value = /*block*/ ctx[8].settings.product_title_2 + "";
	let t21;
	let t22;
	let div16;
	let div14;
	let span3;
	let t23_value = /*block*/ ctx[8].settings.product_2_param_1_value + "";
	let t23;
	let span3_transition;
	let t24;
	let t25_value = /*block*/ ctx[8].settings.product_2_param_1_unit + "";
	let t25;
	let t26;
	let div15;
	let t27_value = /*block*/ ctx[8].settings.param_1 + "";
	let t27;
	let t28;
	let div19;
	let div17;
	let span4;
	let t29_value = /*block*/ ctx[8].settings.product_2_param_2_value + "";
	let t29;
	let span4_transition;
	let t30;
	let t31_value = /*block*/ ctx[8].settings.product_2_param_2_unit + "";
	let t31;
	let t32;
	let div18;
	let t33_value = /*block*/ ctx[8].settings.param_2 + "";
	let t33;
	let t34;
	let div22;
	let div20;
	let span5;
	let t35_value = /*block*/ ctx[8].settings.product_2_param_3_value + "";
	let t35;
	let span5_transition;
	let t36;
	let t37_value = /*block*/ ctx[8].settings.product_2_param_3_unit + "";
	let t37;
	let t38;
	let div21;
	let t39_value = /*block*/ ctx[8].settings.param_3 + "";
	let t39;
	let t40;
	...
	return {
		...
		l(nodes) {
			...
			div12 = claim_element(div24_nodes, "DIV", { class: true });
		...
		h() {
			attr(img0, "class", " svelte-fts4kk");
			attr(img0, "loading", "eager");
			if (!src_url_equal(img0.src, img0_src_value = /*liquid*/ ctx[2].img_url(/*block*/ ctx[8].settings.product_image_1, '300x'))) attr(img0, "src", img0_src_value);
			attr(img0, "width", img0_width_value = 300);
			attr(img0, "height", img0_height_value = /*liquid*/ ctx[2].divided_by(300, /*block*/ ctx[8].settings.product_image_1.aspect_ratio));
			attr(div0, "class", "product-image image-1 svelte-fts4kk");
			attr(select, "class", "product-title svelte-fts4kk");
			if (/*current_block*/ ctx[1] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[6].call(select));
			attr(span0, "class", "svelte-fts4kk");
			attr(div1, "class", "param-values svelte-fts4kk");
			attr(div2, "class", "param-name svelte-fts4kk");
			attr(div3, "class", "param-container svelte-fts4kk");
			attr(span1, "class", "svelte-fts4kk");
			attr(div4, "class", "param-values svelte-fts4kk");
			attr(div5, "class", "param-name svelte-fts4kk");
			attr(div6, "class", "param-container svelte-fts4kk");
			attr(span2, "class", "svelte-fts4kk");
			attr(div7, "class", "param-values svelte-fts4kk");
			attr(div8, "class", "param-name svelte-fts4kk");
			attr(div9, "class", "param-container svelte-fts4kk");
			attr(div10, "class", "product-info svelte-fts4kk");
			attr(div11, "class", "comparison-item svelte-fts4kk");
			attr(img1, "class", " svelte-fts4kk");
			attr(img1, "loading", "eager");
			if (!src_url_equal(img1.src, img1_src_value = /*liquid*/ ctx[2].img_url(/*block*/ ctx[8].settings.product_image_2, '300x'))) attr(img1, "src", img1_src_value);
			attr(img1, "width", img1_width_value = 300);
			attr(img1, "height", img1_height_value = /*liquid*/ ctx[2].divided_by(300, /*block*/ ctx[8].settings.product_image_2.aspect_ratio));
			attr(div12, "class", "product-image image-2 svelte-fts4kk");
			attr(div13, "class", "product-title svelte-fts4kk");
			attr(span3, "class", "svelte-fts4kk");
			attr(div14, "class", "param-values svelte-fts4kk");
			attr(div15, "class", "param-name svelte-fts4kk");
			attr(div16, "class", "param-container svelte-fts4kk");
			attr(span4, "class", "svelte-fts4kk");
			attr(div17, "class", "param-values svelte-fts4kk");
			attr(div18, "class", "param-name svelte-fts4kk");
			attr(div19, "class", "param-container svelte-fts4kk");
			attr(span5, "class", "svelte-fts4kk");
			attr(div20, "class", "param-values svelte-fts4kk");
			attr(div21, "class", "param-name svelte-fts4kk");
			attr(div21, "data-failed", "true");
			attr(div22, "class", "param-container svelte-fts4kk");
			attr(div23, "class", "product-info svelte-fts4kk");
			attr(div24, "class", "comparison-item svelte-fts4kk");
			attr(div25, "class", "comparison svelte-fts4kk");
			attr(div26, "class", "comparison-container svelte-fts4kk");
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			...
			if (!current || dirty & /*section*/ 1 && !src_url_equal(img0.src, img0_src_value = /*liquid*/ ctx[2].img_url(/*block*/ ctx[8].settings.product_image_1, '300x'))) {
				attr(img0, "src", img0_src_value);
			}

			if (!current || dirty & /*section*/ 1 && img0_height_value !== (img0_height_value = /*liquid*/ ctx[2].divided_by(300, /*block*/ ctx[8].settings.product_image_1.aspect_ratio))) {
			...
			if ((!current || dirty & /*section*/ 1) && t2_value !== (t2_value = /*block*/ ctx[8].settings.product_1_param_1_value + "")) set_data(t2, t2_value);
			if ((!current || dirty & /*section*/ 1) && t4_value !== (t4_value = /*block*/ ctx[8].settings.product_1_param_1_unit + "")) set_data(t4, t4_value);
			if ((!current || dirty & /*section*/ 1) && t6_value !== (t6_value = /*block*/ ctx[8].settings.param_1 + "")) set_data(t6, t6_value);
			if ((!current || dirty & /*section*/ 1) && t8_value !== (t8_value = /*block*/ ctx[8].settings.product_1_param_2_value + "")) set_data(t8, t8_value);
			if ((!current || dirty & /*section*/ 1) && t10_value !== (t10_value = /*block*/ ctx[8].settings.product_1_param_2_unit + "")) set_data(t10, t10_value);
			if ((!current || dirty & /*section*/ 1) && t12_value !== (t12_value = /*block*/ ctx[8].settings.param_2 + "")) set_data(t12, t12_value);
			if ((!current || dirty & /*section*/ 1) && t14_value !== (t14_value = /*block*/ ctx[8].settings.product_1_param_3_value + "")) set_data(t14, t14_value);
			if ((!current || dirty & /*section*/ 1) && t16_value !== (t16_value = /*block*/ ctx[8].settings.product_1_param_3_unit + "")) set_data(t16, t16_value);
			if ((!current || dirty & /*section*/ 1) && t18_value !== (t18_value = /*block*/ ctx[8].settings.param_3 + "")) set_data(t18, t18_value);

			if (!current || dirty & /*section*/ 1 && !src_url_equal(img1.src, img1_src_value = /*liquid*/ ctx[2].img_url(/*block*/ ctx[8].settings.product_image_2, '300x'))) {
				attr(img1, "src", img1_src_value);
			}

			if (!current || dirty & /*section*/ 1 && img1_height_value !== (img1_height_value = /*liquid*/ ctx[2].divided_by(300, /*block*/ ctx[8].settings.product_image_2.aspect_ratio))) {
				attr(img1, "height", img1_height_value);
			}

			if ((!current || dirty & /*section*/ 1) && t21_value !== (t21_value = /*block*/ ctx[8].settings.product_title_2 + "")) set_data(t21, t21_value);
			if ((!current || dirty & /*section*/ 1) && t23_value !== (t23_value = /*block*/ ctx[8].settings.product_2_param_1_value + "")) set_data(t23, t23_value);
			if ((!current || dirty & /*section*/ 1) && t25_value !== (t25_value = /*block*/ ctx[8].settings.product_2_param_1_unit + "")) set_data(t25, t25_value);
			if ((!current || dirty & /*section*/ 1) && t27_value !== (t27_value = /*block*/ ctx[8].settings.param_1 + "")) set_data(t27, t27_value);
			if ((!current || dirty & /*section*/ 1) && t29_value !== (t29_value = /*block*/ ctx[8].settings.product_2_param_2_value + "")) set_data(t29, t29_value);
			if ((!current || dirty & /*section*/ 1) && t31_value !== (t31_value = /*block*/ ctx[8].settings.product_2_param_2_unit + "")) set_data(t31, t31_value);
			if ((!current || dirty & /*section*/ 1) && t33_value !== (t33_value = /*block*/ ctx[8].settings.param_2 + "")) set_data(t33, t33_value);
			if ((!current || dirty & /*section*/ 1) && t35_value !== (t35_value = /*block*/ ctx[8].settings.product_2_param_3_value + "")) set_data(t35, t35_value);
			if ((!current || dirty & /*section*/ 1) && t37_value !== (t37_value = /*block*/ ctx[8].settings.product_2_param_3_unit + "")) set_data(t37, t37_value);
			if ((!current || dirty & /*section*/ 1) && t39_value !== (t39_value = /*block*/ ctx[8].settings.param_3 + "")) set_data(t39, t39_value);
		},
		i(local) {
			if (current) return;
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			option.__value = option_value_value = /*forloop*/ ctx[9].index;
			option.value = option.__value;
			attr(option, "class", "svelte-fts4kk");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*section*/ 1 && t0_value !== (t0_value = /*block*/ ctx[8].settings.product_title_1 + "")) set_data(t0, t0_value);

			if (dirty & /*section*/ 1 && option_value_value !== (option_value_value = /*forloop*/ ctx[9].index)) {
...
function create_each_block(ctx) {
	let if_block_anchor;
	let current;
	let if_block = /*current_block*/ ctx[1] == /*forloop*/ ctx[9].index && create_if_block(ctx);
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h1, "class", " svelte-fts4kk");
			attr(h2, "class", " svelte-fts4kk");
			attr(div0, "class", "transition-enforcement svelte-fts4kk");
			attr(div1, "class", "comparison-section-wrapper svelte-fts4kk");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	function changeColor(block) {
		...
		$$invalidate(
			0,
			section.blocks = section.blocks.map(b => b === block
			? {
					...b,
					settings: { ...b.settings, bg_color: '#ddd' }
				}
			: b),
			section
		);
	...
	$$self.$$set = $$props => {
		...
		if ('section$settings' in $$props) $$invalidate(4, section$settings = $$props.section$settings);
		if ('section$blocks' in $$props) $$invalidate(5, section$blocks = $$props.section$blocks);
	};
