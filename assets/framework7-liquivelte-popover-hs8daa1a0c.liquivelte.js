...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			if (default_slot) {
				if (default_slot.p && (!current || dirty & /*$$scope, f7Popover*/ 65538)) {
					update_slot_base(
						default_slot,
...
function instance_1($$self, $$props, $$invalidate) {
	const omit_props_names = [
		"classes","opened","animate","targetEl","backdrop","backdropEl","closeByBackdropClick","closeByOutsideClick","closeOnEscape","containerEl","verticalPosition","instance"
	];
	...
	$$self.$$set = $$new_props => {
		...
		if ('verticalPosition' in $$new_props) $$invalidate(14, verticalPosition = $$new_props.verticalPosition);
