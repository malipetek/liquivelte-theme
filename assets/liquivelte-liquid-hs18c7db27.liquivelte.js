...
var cachedLiquid = (liquid_expression_cache = {}) => ({
    ...
    color_to_rgb: (color) => {
        return Color$1(color).rgb().toString();
    },
    color_lighten: (color, amount) => {
        return Color$1(color).lighten(amount / 100).toString();
    },
    color_darken: (color, amount) => {
        return Color$1(color).darken(amount / 100).toString();
    }
});

export { cachedLiquid, commonjsGlobal };
