import { SvelteComponent, init, safe_not_equal, element, space, text, claim_element, children, detach, claim_space, claim_text, attr, set_style, insert_hydration, append_hydration, noop, destroy_each, component_subscribe, onMount, src_url_equal, add_render_callback, add_resize_listener, tweened, binding_callbacks, identity } from './liquivelte-svelte-hs532e1aa9.liquivelte.js';
...
function get_each_context(ctx, list, i) {
	...
	const constants_0 = {
		...
		last: /*index*/ child_ctx[35] === /*section*/ child_ctx[4].blocks.length - 1,
		rindex: /*section*/ child_ctx[4].blocks.length - /*index*/ child_ctx[35],
		rindex0: /*section*/ child_ctx[4].blocks.length - /*index*/ child_ctx[35] - 1,
...
// (115:6) {#each  section.blocks as block, index   }
function create_each_block(ctx) {
	...
	function div_elementresize_handler() {
		/*div_elementresize_handler*/ ctx[23].call(div, /*forloop*/ ctx[33]);
	}
	...
	return {
		...
		h() {
			...
			attr(source0, "srcset", source0_srcset_value = /*liquid*/ ctx[9].img_url(/*block*/ ctx[32].settings.image, 'x800'));
			attr(source1, "media", "(min-width:1200px)");
			attr(source1, "srcset", source1_srcset_value = /*liquid*/ ctx[9].img_url(/*block*/ ctx[32].settings.image, 'x800'));
			attr(img, "class", " svelte-12dbek");
			if (!src_url_equal(img.src, img_src_value = /*liquid*/ ctx[9].img_url(/*block*/ ctx[32].settings.image, 'x800'))) attr(img, "src", img_src_value);
			attr(img, "alt", img_alt_value = /*block*/ ctx[32].settings.image.alt);
			set_style(img, "width", "auto");
			attr(picture, "class", " svelte-12dbek");
			attr(div, "class", "image-container a svelte-12dbek");
			set_style(div, "--image-aspect-ratio", /*block*/ ctx[32].settings.image.aspect_ratio);
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*section*/ 16 && source0_srcset_value !== (source0_srcset_value = /*liquid*/ ctx[9].img_url(/*block*/ ctx[32].settings.image, 'x800'))) {
				attr(source0, "srcset", source0_srcset_value);
			}

			if (dirty[0] & /*section*/ 16 && source1_srcset_value !== (source1_srcset_value = /*liquid*/ ctx[9].img_url(/*block*/ ctx[32].settings.image, 'x800'))) {
				attr(source1, "srcset", source1_srcset_value);
			}

			if (dirty[0] & /*section*/ 16 && !src_url_equal(img.src, img_src_value = /*liquid*/ ctx[9].img_url(/*block*/ ctx[32].settings.image, 'x800'))) {
				attr(img, "src", img_src_value);
			}

			if (dirty[0] & /*section*/ 16 && img_alt_value !== (img_alt_value = /*block*/ ctx[32].settings.image.alt)) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		if ('lec' in $$props) $$invalidate(11, lec = $$props.lec);
		if ('sectionƒƒsettings' in $$props) $$invalidate(12, sectionƒƒsettings = $$props.sectionƒƒsettings);
		if ('sectionƒƒblocks' in $$props) $$invalidate(13, sectionƒƒblocks = $$props.sectionƒƒblocks);
		if ('imbalance' in $$props) $$invalidate(14, imbalance = $$props.imbalance);
	};
