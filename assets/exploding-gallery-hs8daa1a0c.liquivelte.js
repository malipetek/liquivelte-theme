import { SvelteComponent, init, safe_not_equal, element, space, text, claim_element, children, detach, claim_space, claim_text, attr, set_style, insert_hydration, append_hydration, noop, destroy_each, getContext, component_subscribe, onMount, src_url_equal, add_render_callback, add_resize_listener, tweened, binding_callbacks, identity } from './liquivelte-svelte-hs532e1aa9.liquivelte.js';
...
function get_each_context(ctx, list, i) {
	...
	const constants_0 = {
		...
		last: /*index*/ child_ctx[34] === /*section*/ child_ctx[4].blocks.length - 1,
		rindex: /*section*/ child_ctx[4].blocks.length - /*index*/ child_ctx[34],
		rindex0: /*section*/ child_ctx[4].blocks.length - /*index*/ child_ctx[34] - 1,
...
// (116:6) {#each  section.blocks as block, index   }
function create_each_block(ctx) {
	...
	function div_elementresize_handler() {
		/*div_elementresize_handler*/ ctx[19].call(div, /*forloop*/ ctx[32]);
	}
	...
	return {
		...
		h() {
			...
			attr(source0, "srcset", source0_srcset_value = /*liquid*/ ctx[9].img_url(/*block*/ ctx[31].settings.image, 'x800'));
			attr(source1, "media", "(min-width:1200px)");
			attr(source1, "srcset", source1_srcset_value = /*liquid*/ ctx[9].img_url(/*block*/ ctx[31].settings.image, 'x800'));
			attr(img, "class", " svelte-12dbek");
			if (!src_url_equal(img.src, img_src_value = /*liquid*/ ctx[9].img_url(/*block*/ ctx[31].settings.image, 'x800'))) attr(img, "src", img_src_value);
			attr(img, "alt", img_alt_value = /*block*/ ctx[31].settings.image.alt);
			set_style(img, "width", "auto");
			attr(picture, "class", " svelte-12dbek");
			attr(div, "class", "image-container a svelte-12dbek");
			set_style(div, "--image-aspect-ratio", /*block*/ ctx[31].settings.image.aspect_ratio);
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*section*/ 16 && source0_srcset_value !== (source0_srcset_value = /*liquid*/ ctx[9].img_url(/*block*/ ctx[31].settings.image, 'x800'))) {
				attr(source0, "srcset", source0_srcset_value);
			}

			if (dirty[0] & /*section*/ 16 && source1_srcset_value !== (source1_srcset_value = /*liquid*/ ctx[9].img_url(/*block*/ ctx[31].settings.image, 'x800'))) {
				attr(source1, "srcset", source1_srcset_value);
			}

			if (dirty[0] & /*section*/ 16 && !src_url_equal(img.src, img_src_value = /*liquid*/ ctx[9].img_url(/*block*/ ctx[31].settings.image, 'x800'))) {
				attr(img, "src", img_src_value);
			}

			if (dirty[0] & /*section*/ 16 && img_alt_value !== (img_alt_value = /*block*/ ctx[31].settings.image.alt)) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			set_style(div2, "height", /*stageHeight*/ ctx[5] + keepFor + "px");
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*fifthImage*/ 131072) {
			if (!fifthImage) {
				$$invalidate(17, fifthImage = [...document.querySelectorAll('.image-container')][4].children[0]);
			}
		}

		if ($$self.$$.dirty[0] & /*container, stage, scrollY, isTopped, keptFor, cachedHeight, progressPercent*/ 124931) {
			if (container && stage) {
				(container.offsetTop, $$invalidate(12, height = container.clientHeight), container.offsetTop < scrollY + window.innerHeight, container.offsetTop - (scrollY + window.innerHeight), $$invalidate(13, isTopped = container.offsetTop - scrollY < 0), $$invalidate(14, cachedHeight = isTopped ? cachedHeight : container.clientHeight), $$invalidate(15, keptFor = Math.abs(container.offsetTop - scrollY)), container.offsetTop - scrollY < 0 && keepFor > keptFor
				? keptFor
				: isTopped ? keepFor : 0, $$invalidate(16, progressPercent = (scrollY + window.innerHeight - container.offsetTop) / (container.clientHeight + window.innerHeight) * 100), $$invalidate(16, progressPercent = progressPercent > 0 ? progressPercent : 0));
