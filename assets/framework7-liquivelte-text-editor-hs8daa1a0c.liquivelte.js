...
import { restProps, createEmitter, noUndefinedProps, f7ready, app, classNames, colorClasses } from './framework7-liquivelte-hsa0091f48.liquivelte.js';
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (root_start_slot) {
				if (root_start_slot.p && (!current || dirty[0] & /*$$scope, f7TextEditor*/ 65540)) {
					update_slot_base(
						root_start_slot,
						...
						: get_slot_changes(root_start_slot_template, /*$$scope*/ ctx[16], dirty, get_root_start_slot_changes),
			...
			if (default_slot) {
				if (default_slot.p && (!current || dirty[0] & /*$$scope, f7TextEditor*/ 65540)) {
					update_slot_base(
						default_slot,
			...
			if (root_end_slot) {
				if (root_end_slot.p && (!current || dirty[0] & /*$$scope, f7TextEditor*/ 65540)) {
					update_slot_base(
						root_end_slot,
						...
						!current
						? get_all_dirty_from_scope(/*$$scope*/ ctx[16])
						: get_slot_changes(root_end_slot_template, /*$$scope*/ ctx[16], dirty, get_root_end_slot_changes),
			...
			if (root_slot) {
				if (root_slot.p && (!current || dirty[0] & /*$$scope, f7TextEditor*/ 65540)) {
					update_slot_base(
						root_slot,
						root_slot_template,
						ctx,
						...
						!current
						? get_all_dirty_from_scope(/*$$scope*/ ctx[16])
						: get_slot_changes(root_slot_template, /*$$scope*/ ctx[16], dirty, get_root_slot_changes),
...
function instance_1($$self, $$props, $$invalidate) {
	const omit_props_names = [
		"classes","mode","value","buttons","customButtons","dividers","imageUrlText","linkUrlText","placeholder","clearFormattingOnPaste","resizable","instance"
	];
