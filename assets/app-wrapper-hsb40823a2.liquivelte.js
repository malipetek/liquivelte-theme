...
// (4936:4) <Page  name="main" classes="main-page" >
...
// (4935:2) <View  main classes="mainview" browserHistoryInitialMatch="{true}" loadInitialPage="{false}" data-url="{ request.path }" browserHistory="{true}" browserHistorySeparator="{""}" preloadPreviousPage="{false}" >
...
// (4952:4) <Link  small popupOpen=".cart-popup" classes="display-flex z-[601] w-[72px]"  >
...
// (4948:2) <Toolbar  position="{'bottom'}" classes="z-[5500] toolbar-bottom" >
...
// (4922:0) <App  theme="auto"    autoDarkMode="{true}"     iosTranslucentBars="{false}" iosTranslucentModals="{false}"    name="My App"    id="com.demoapp.test"    routes="{routes}"    viewMainClass="mainview"    >
