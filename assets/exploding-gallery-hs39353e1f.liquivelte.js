import { element, space, claim_element, children, claim_space, detach, attr, src_url_equal, set_style, add_render_callback, insert_hydration, append_hydration, add_resize_listener, text, claim_text, noop, destroy_each, tweened, identity, component_subscribe, binding_callbacks, SvelteComponent, init, safe_not_equal } from './liquivelte-svelte-hs623f7d73.liquivelte.js';
...
// (114:6) {#each  section.blocks as block, index  }
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('section$settings' in $$props) $$invalidate(12, section$settings = $$props.section$settings);
		if ('section$blocks' in $$props) $$invalidate(13, section$blocks = $$props.section$blocks);
