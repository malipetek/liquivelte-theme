...
function instance_1($$self, $$props, $$invalidate) {
	...
	const omit_props_names = [
		"lec","classes","opened","animate","top","bottom","position","backdrop","backdropEl","closeByBackdropClick","closeByOutsideClick","closeOnEscape","push","swipeToClose","swipeToStep","swipeHandler","containerEl","instance"
	];
