...
function create_fragment(ctx) {
	...
	let t1;
	let current;
	const fixed_slot_template = /*#slots*/ ctx[25].fixed;
	const fixed_slot = create_slot(fixed_slot_template, ctx, /*$$scope*/ ctx[24], get_fixed_slot_context);
	const default_slot_template = /*#slots*/ ctx[25].default;
	const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ ctx[24], get_default_slot_context);
	const static_slot_template = /*#slots*/ ctx[25].static;
	const static_slot = create_slot(static_slot_template, ctx, /*$$scope*/ ctx[24], get_static_slot_context);
	...
	return {
		...
		p(ctx, dirty) {
			if (fixed_slot) {
				if (fixed_slot.p && (!current || dirty[0] & /*$$scope, f7Sheet*/ 16777224)) {
					update_slot_base(
						fixed_slot,
						fixed_slot_template,
						ctx,
						...
						: get_slot_changes(fixed_slot_template, /*$$scope*/ ctx[24], dirty, get_fixed_slot_changes),
			...
			if (default_slot) {
				if (default_slot.p && (!current || dirty[0] & /*$$scope, f7Sheet*/ 16777224)) {
					update_slot_base(
						default_slot,
			...
			if (static_slot) {
				if (static_slot.p && (!current || dirty[0] & /*$$scope, f7Sheet*/ 16777224)) {
					update_slot_base(
						static_slot,
						...
						!current
						? get_all_dirty_from_scope(/*$$scope*/ ctx[24])
						: get_slot_changes(static_slot_template, /*$$scope*/ ctx[24], dirty, get_static_slot_changes),
...
function instance_1($$self, $$props, $$invalidate) {
	...
	const omit_props_names = [
		"classes","opened","animate","top","bottom","position","backdrop","backdropEl","closeByBackdropClick","closeByOutsideClick","closeOnEscape","push","swipeToClose","swipeToStep","swipeHandler","containerEl","instance"
	];
		...
		const params = {
			...
			on: {
				...
				_swipeStep(isSwipeStep) {
					$$invalidate(22, state.swipeStep = isSwipeStep, state);
				}
			}
		};
