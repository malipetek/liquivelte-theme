...
import { App } from './framework7-liquivelte-app-hs7b7e08a9.liquivelte.js';
...
import { Toolbar } from './framework7-liquivelte-toolbar-hsac8523a4.liquivelte.js';
...
import './framework7-liquivelte-routable-modals-hs65a371ef.liquivelte.js';
...
// (4934:4) <Page  name="main" classes="main-page" >
...
// (4933:2) <View  main classes="mainview" browserHistoryInitialMatch="{true}" loadInitialPage="{false}" data-url="{ request.path }" browserHistory="{true}" browserHistorySeparator="{""}" preloadPreviousPage="{false}" >
...
// (4950:4) <Link  small popupOpen=".cart-popup" classes="display-flex z-[601] w-[72px]"  >
...
// (4946:2) <Toolbar  position="{'bottom'}" classes="z-[5500] toolbar-bottom" >
...
// (4920:0) <App  theme="auto"    autoDarkMode="{true}"     iosTranslucentBars="{false}" iosTranslucentModals="{false}"    name="My App"    id="com.demoapp.test"    routes="{routes}"    viewMainClass="mainview"    >
