...
function create_fragment$5(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", div_class_value = "flex " + /*button_group_classes*/ ctx[0] + " svelte-1lqhjtm");
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*button_group_classes*/ 1 && div_class_value !== (div_class_value = "flex " + /*button_group_classes*/ ctx[0] + " svelte-1lqhjtm")) {
				attr(div, "class", div_class_value);
			}
