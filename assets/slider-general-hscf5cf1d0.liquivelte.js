...
import { freeMode, Mousewheel } from './framework7-liquivelte-get-params-hsa26ede4c.liquivelte.js';
import { Image } from './header-hs625ca8e2.liquivelte.js';
...
function create_fragment$6(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", div_class_value = "card " + /*card_classes*/ ctx[1] + " svelte-1gss31k");
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*card_classes*/ 2 && div_class_value !== (div_class_value = "card " + /*card_classes*/ ctx[1] + " svelte-1gss31k")) {
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", div_class_value = "flex " + /*button_group_classes*/ ctx[0] + " svelte-5lyn7h");
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*button_group_classes*/ 1 && div_class_value !== (div_class_value = "flex " + /*button_group_classes*/ ctx[0] + " svelte-5lyn7h")) {
				attr(div, "class", div_class_value);
			}
...
// (57:6) {#if block.settings.cta_url }
...
// (58:8) <Button  classes="" href="{ block.settings.cta_url }" >
...
// (60:6) {#if block.settings.cta_url_2 }
...
// (61:8) <Button  classes="" href="{ block.settings.cta_url_2 }" >
...
// (50:2) <Card  settings="{ block.settings }" >
