...
function create_default_slot_4(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			const view_changes = {};
			if (dirty & /*viewSelector*/ 4) view_changes.linksView = /*viewSelector*/ ctx[2];
			if (dirty & /*url*/ 2) view_changes.url = /*url*/ ctx[1];
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			const panel_changes = {};
			if (dirty & /*side*/ 16) panel_changes.side = /*side*/ ctx[4];
...
function create_fragment(ctx) {
	...
	let t2;
	let t3;
	let show_if = /*openIn*/ ctx[0].indexOf('panel') === 0;
	let if_block4_anchor;
	let current;
	let if_block0 = /*openIn*/ ctx[0] === 'popup' && create_if_block_4(ctx);
	let if_block1 = /*openIn*/ ctx[0] === 'loginScreen' && create_if_block_3(ctx);
	let if_block2 = /*openIn*/ ctx[0] === 'sheet' && create_if_block_2(ctx);
	let if_block3 = /*openIn*/ ctx[0] === 'popover' && create_if_block_1(ctx);
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*openIn*/ 1) show_if = /*openIn*/ ctx[0].indexOf('panel') === 0;
