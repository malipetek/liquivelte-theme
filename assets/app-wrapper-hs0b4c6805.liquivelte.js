...
import { App } from './framework7-liquivelte-app-hs7cb4fc62.liquivelte.js';
import { Badge } from './framework7-liquivelte-badge-hs78101d76.liquivelte.js';
...
import { Toolbar } from './framework7-liquivelte-toolbar-hsbdd7858d.liquivelte.js';
...
import './framework7-liquivelte-routable-modals-hs863f5c3e.liquivelte.js';
import './liquivelte-liquid-hs1c1d82c2.liquivelte.js';
...
// (8060:4) <Page  name="main" classes="main-page" >
...
// (8059:2) <View  main classes="mainview" browserHistoryInitialMatch="{true}" loadInitialPage="{false}" data-url="{ request.path }" browserHistory="{true}" browserHistorySeparator="{""}" preloadPreviousPage="{false}" >
...
// (8046:0) <App  theme="auto"    autoDarkMode="{true}"     iosTranslucentBars="{false}" iosTranslucentModals="{false}"    name="My App"    id="com.demoapp.test"    routes="{routes}"    viewMainClass="mainview"    >
