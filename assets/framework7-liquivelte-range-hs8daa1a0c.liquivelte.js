...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (default_slot) {
				if (default_slot.p && (!current || dirty[0] & /*$$scope, f7Range*/ 67108896)) {
					update_slot_base(
						default_slot,
...
function instance_1($$self, $$props, $$invalidate) {
	const omit_props_names = [
		"classes","init","value","min","max","step","label","dual","vertical","verticalReversed","draggableBar","formatLabel","scale","scaleSteps","scaleSubSteps","formatScaleLabel","limitKnobPosition","name","input","inputId","disabled","instance"
	];
