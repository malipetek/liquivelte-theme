...
function create_default_slot_5(ctx) {
	...
	return {
		...
		h() {
			if (!src_url_equal(img.src, img_src_value = /*liquid*/ ctx[3].img_url(/*product*/ ctx[1].featured_image, '300x'))) attr(img, "src", img_src_value);
		},
		m(target, anchor) {
			insert_hydration(target, img, anchor);
		},
		p(ctx, dirty) {
			if (dirty & /*product*/ 2 && !src_url_equal(img.src, img_src_value = /*liquid*/ ctx[3].img_url(/*product*/ ctx[1].featured_image, '300x'))) {
...
// (21:0) <Card  class="card-header-pic" swipeToClose hideToolbarOnOpen hideNavbarOnOpen bind:expandableOpened="{expandableOpened}"     lec={lec} >
...
// (19:0) <BlockTitle   products={products} slidesPerView={slidesPerView}  sectionƒƒsettings={sectionƒƒsettings}   lec={lec} >
...
// (32:4) <SwiperSlide   products={products} slidesPerView={slidesPerView}  sectionƒƒsettings={sectionƒƒsettings}   lec={lec} >
function create_default_slot_2(ctx) {
	...
	productcard = new Product_card({
			props: {
				...
				slidesPerView: /*slidesPerView*/ ctx[3],
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*slidesPerView*/ 8) productcard_changes.slidesPerView = /*slidesPerView*/ ctx[3];
...
// (22:4) {#each  products as product, index  }
function create_each_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*slidesPerView*/ 8) swiperslide_changes.slidesPerView = /*slidesPerView*/ ctx[3];
			...
			if (dirty & /*$$scope, products, slidesPerView, sectionƒƒsettings, lec*/ 1039) {
...
// (21:2) <Swiper    products={products} slidesPerView={slidesPerView}  sectionƒƒsettings={sectionƒƒsettings}   lec={lec} >
function create_default_slot_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*products, slidesPerView, sectionƒƒsettings, lec*/ 15) {
...
// (18:0) <Block   products={products} slidesPerView={slidesPerView}  sectionƒƒsettings={sectionƒƒsettings}   lec={lec} >
function create_default_slot(ctx) {
	...
	return {
		...
		h() {
			set_style(div, "--slides-per-view", /*slidesPerView*/ ctx[3]);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*slidesPerView*/ 8) blocktitle_changes.slidesPerView = /*slidesPerView*/ ctx[3];
			...
			if (dirty & /*slidesPerView*/ 8) swiper_changes.slidesPerView = /*slidesPerView*/ ctx[3];
			...
			if (!current || dirty & /*slidesPerView*/ 8) {
				set_style(div, "--slides-per-view", /*slidesPerView*/ ctx[3]);
			}
		},
		i(local) {
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*slidesPerView*/ 8) block_changes.slidesPerView = /*slidesPerView*/ ctx[3];
			...
			if (dirty & /*$$scope, slidesPerView, products, sectionƒƒsettings, lec*/ 1039) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('slidesPerView' in $$props) $$invalidate(3, slidesPerView = $$props.slidesPerView);
	};

	return [lec, sectionƒƒsettings, products, slidesPerView];
}
