...
import { restProps, classNames, colorClasses } from './framework7-liquivelte-hs7cccafc5.liquivelte.js';
...
function create_fragment(ctx) {
	...
	let div_levels = [
		{
			class: div_class_value = "accordion-item-content " + /*classes*/ ctx[0] + " " + /*computedClasses*/ ctx[1]
		},
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			set_attributes(div, div_data = get_spread_update(div_levels, [
				(!current || dirty & /*classes*/ 1 && div_class_value !== (div_class_value = "accordion-item-content " + /*classes*/ ctx[0] + " " + /*computedClasses*/ ctx[1])) && { class: div_class_value },
