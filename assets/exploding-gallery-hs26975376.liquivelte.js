...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(picture, "class", " svelte-1i2lyr4");
			attr(div, "class", "image-container a svelte-1i2lyr4");
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(div0, "class", "exp-gallery-stage svelte-1i2lyr4");
			attr(div1, "class", "stage-container svelte-1i2lyr4");
			attr(div2, "class", "exp-gallery-placeholder");
			set_style(div2, "height", /*liquid*/ ctx[9].plus(/*stageHeight*/ ctx[5], keepFor) + "px");
			attr(div3, "class", "exp-gallery-container svelte-1i2lyr4");
