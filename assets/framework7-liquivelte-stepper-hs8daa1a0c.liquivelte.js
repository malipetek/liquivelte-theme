...
function create_if_block_1(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(input_1, "input", /*onInput*/ ctx[13]),
					listen(input_1, "change", /*onChange*/ ctx[14])
				];
...
function create_if_block(ctx) {
	...
	return {
		...
		l(nodes) {
			div = claim_element(nodes, "DIV", { class: true });
			var div_nodes = children(div);
			t = claim_text(div_nodes, /*value*/ ctx[0]);
			div_nodes.forEach(detach);
			this.h();
		},
		h() {
...
function create_fragment(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(div0, "click", /*onMinusClick*/ ctx[15]),
					listen(div1, "click", /*onPlusClick*/ ctx[16])
				];
...
function instance_1($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$new_props => {
		...
		if ('lec' in $$new_props) $$invalidate(18, lec = $$new_props.lec);
