import { $ as $$1, methods, getWindow, getDocument } from './framework7-liquivelte-get-params-hsb1e4d723.liquivelte.js';
import { htm } from './htm.js-hsb1e6830e.liquivelte.js';
...
var FrameworkClass = Framework7Class;
...
class Framework7 extends FrameworkClass {
  constructor(params) {
    if (params === void 0) {
      params = {};
    }
...
class Router extends FrameworkClass {
...
let View$1 = class View extends FrameworkClass {
...
let Modal$1 = class Modal extends FrameworkClass {
...
let Panel$1 = class Panel extends FrameworkClass {
  constructor(app, params) {
    if (params === void 0) {
      params = {};
    }
...
let Popover$1 = class Popover extends Modal$2 {
  constructor(app, params) {
    const extendedParams = extend({
      on: {}
...
let Stepper$1 = class Stepper extends FrameworkClass {
  constructor(app, params) {
    super(params, [app]);
    const stepper = this;
    const defaults = {
...
let SmartSelect$1 = class SmartSelect extends FrameworkClass {
  constructor(app, params) {
    if (params === void 0) {
      params = {};
    }
...
let Range$1 = class Range extends FrameworkClass {
  constructor(app, params) {
    super(params, [app]);
    const range = this;
    const support = getSupport();
...
let Notification$1 = class Notification extends Modal$2 {
  constructor(app, params) {
    const extendedParams = extend({
      on: {}
...
let Searchbar$1 = class Searchbar extends FrameworkClass {
  constructor(app, params) {
    if (params === void 0) {
      params = {};
    }
...
export { Accordion$1 as Accordion, Framework7$1 as Framework7, Menu$1 as Menu, Notification, Panel, Popover, Popup, Progressbar$1 as Progressbar, Range, Searchbar, SmartSelect, Stepper };
