...
import { Image } from './header-hsea4dfed2.liquivelte.js';
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", div_class_value = "flex " + /*button_group_classes*/ ctx[0] + " svelte-yio10i");
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*button_group_classes*/ 1 && div_class_value !== (div_class_value = "flex " + /*button_group_classes*/ ctx[0] + " svelte-yio10i")) {
				attr(div, "class", div_class_value);
			}
...
// (53:6) {#if block.settings.cta_url }
...
// (54:8) <Button  classes="" href="{ block.settings.cta_url }" >
...
// (56:6) {#if block.settings.cta_url_2 }
...
// (57:8) <Button  classes="" href="{ block.settings.cta_url_2 }" >
...
// (46:2) <Card  settings="{ block.settings }" >
