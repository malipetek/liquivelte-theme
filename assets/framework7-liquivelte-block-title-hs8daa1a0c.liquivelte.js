...
function instance($$self, $$props, $$invalidate) {
	const omit_props_names = ["lec","large","medium","classes"];
	...
	return [large, medium, classes, computedClasses, $$restProps, lec, $$scope, slots];
}

class Block_title extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { lec: 5, large: 0, medium: 1, classes: 2 });
	}
}
