...
function create_fragment(ctx) {
	...
	let div_levels = [
		{
			class: div_class_value = "'block-title' " + /*classes*/ ctx[2]
		},
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			set_attributes(div, div_data = get_spread_update(div_levels, [
				(!current || dirty & /*classes*/ 4 && div_class_value !== (div_class_value = "'block-title' " + /*classes*/ ctx[2])) && { class: div_class_value },
...
function instance($$self, $$props, $$invalidate) {
	...
	return [large, medium, classes, $$restProps, lec, className, $$scope, slots];
}

class Block_title extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { lec: 4, large: 0, medium: 1, class: 5 });
	}
}
