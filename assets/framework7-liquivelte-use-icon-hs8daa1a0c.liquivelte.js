...
function create_default_slot(ctx) {
	let if_block_anchor;
	let current;
	let if_block = /*icon*/ ctx[1].badge && create_if_block(ctx);
...
class Use_icon extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { lec: 0, icon: 1 });
	}
}
