		...
		onMount(() => {
			f7ready(() => {
				f7.views.main.on('pageMounted', ({ pageEl, route }) => {
					console.log(source.bgBlack.redBright('page is mounting', route.path, route.params, route.query));
				...
				f7.views.main.on('pageInit', ({ route }) => {
					console.log(source.bgGreen.black('page is initializing', route.path, route.params, route.query));
				});

				f7.views.main.on('pageReinit', ({ route }) => {
					console.log(source.bgBlue.black('page is re initializing', route.path, route.params, route.query));
				});
			});
		});
