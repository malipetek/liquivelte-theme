import { SvelteComponent, init, safe_not_equal, assign, create_component, claim_component, mount_component, get_spread_update, get_spread_object, transition_in, transition_out, destroy_component, getContext, exclude_internal_props, empty, insert_hydration, group_outros, check_outros, detach, text, claim_text, set_data } from './liquivelte-svelte-hs090e373f.liquivelte.js';
import { Icon } from './framework7-liquivelte-icon-hs04fd4a05.liquivelte.js';
