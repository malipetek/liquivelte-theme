import { SvelteComponent, init, safe_not_equal, assign, element, claim_element, children, detach, set_attributes, insert_hydration, group_outros, transition_out, check_outros, transition_in, get_spread_update, compute_rest_props, getContext, onMount, afterUpdate, beforeUpdate, onDestroy, exclude_internal_props, binding_callbacks, create_slot, update_slot_base, get_all_dirty_from_scope, get_slot_changes, attr } from './liquivelte-svelte-hs75fa7249.liquivelte.js';
...
function create_else_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (default_slot) {
				if (default_slot.p && (!current || dirty & /*$$scope, slideData*/ 288)) {
					update_slot_base(
						default_slot,
...
function instance($$self, $$props, $$invalidate) {
	let slideData;
	const omit_props_names = ["importsSeek","zoom","virtualIndex","classes"];
