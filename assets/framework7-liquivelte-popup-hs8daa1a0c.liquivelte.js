...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (default_slot) {
				if (default_slot.p && (!current || dirty[0] & /*$$scope, f7Popup*/ 131076)) {
					update_slot_base(
						default_slot,
...
function instance_1($$self, $$props, $$invalidate) {
	const omit_props_names = [
		"classes","tabletFullscreen","opened","animate","backdrop","backdropEl","closeByBackdropClick","closeOnEscape","swipeToClose","swipeHandler","push","containerEl","instance"
	];
