...
function instance_1($$self, $$props, $$invalidate) {
	const omit_props_names = [
		"lec","classes","tabletFullscreen","opened","animate","backdrop","backdropEl","closeByBackdropClick","closeOnEscape","swipeToClose","swipeHandler","push","containerEl","instance"
	];
