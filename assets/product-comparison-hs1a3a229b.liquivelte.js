import { commonjsGlobal, internal, SvelteComponent, init, safe_not_equal, element, text, space, claim_element, children, claim_text, detach, claim_space, attr, insert_hydration, append_hydration, set_data, transition_in, check_outros, transition_out, destroy_each, empty, group_outros, select_value, set_style, add_render_callback, create_bidirectional_transition, cubicInOut, fade, src_url_equal, select_option, listen } from './liquivelte-svelte-hs532e1aa9.liquivelte.js';
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			set_style(div0, "--ratio", /*block*/ ctx[8].settings.product_image_1.aspect_ratio);
			...
			attr(div3, "class", "param-container svelte-2hua15");
			attr(span1, "class", "svelte-2hua15");
			attr(div4, "class", "param-values svelte-2hua15");
			attr(div5, "class", "param-name svelte-2hua15");
			attr(div6, "class", "param-container svelte-2hua15");
			attr(span2, "class", "svelte-2hua15");
			attr(div7, "class", "param-values svelte-2hua15");
			attr(div8, "class", "param-name svelte-2hua15");
			attr(div9, "class", "param-container svelte-2hua15");
			attr(div10, "class", "product-info svelte-2hua15");
			...
			set_style(div12, "--ratio", /*block*/ ctx[8].settings.product_image_1.aspect_ratio);
			attr(div13, "class", "product-title svelte-2hua15");
			attr(span3, "class", "svelte-2hua15");
			attr(div14, "class", "param-values svelte-2hua15");
			attr(div15, "class", "param-name svelte-2hua15");
			attr(div16, "class", "param-container svelte-2hua15");
			attr(span4, "class", "svelte-2hua15");
			attr(div17, "class", "param-values svelte-2hua15");
			attr(div18, "class", "param-name svelte-2hua15");
			attr(div19, "class", "param-container svelte-2hua15");
			attr(span5, "class", "svelte-2hua15");
			attr(div20, "class", "param-values svelte-2hua15");
			attr(div21, "class", "param-name svelte-2hua15");
			attr(div21, "data-failed", "true");
			attr(div22, "class", "param-container svelte-2hua15");
			attr(div23, "class", "product-info svelte-2hua15");
			attr(div24, "class", "comparison-item svelte-2hua15");
			attr(div25, "class", "comparison svelte-2hua15");
			attr(div26, "class", "comparison-container svelte-2hua15");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h1, "class", " svelte-2hua15");
			attr(h2, "class", " svelte-2hua15");
			attr(div0, "class", "transition-enforcement svelte-2hua15");
			attr(div1, "class", "comparison-section-wrapper svelte-2hua15");
		},
		m(target, anchor) {
