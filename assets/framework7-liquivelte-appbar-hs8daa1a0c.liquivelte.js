import { SvelteComponent, init, safe_not_equal, create_slot, assign, element, space, claim_element, children, claim_space, detach, set_attributes, insert_hydration, append_hydration, update_slot_base, get_all_dirty_from_scope, get_slot_changes, group_outros, transition_out, check_outros, transition_in, get_spread_update, compute_rest_props, getContext, exclude_internal_props, attr } from './liquivelte-svelte-hs532e1aa9.liquivelte.js';
			...
			if (before_inner_slot) {
				if (before_inner_slot.p && (!current || dirty & /*$$scope*/ 512)) {
					update_slot_base(
						...
						!current
						? get_all_dirty_from_scope(/*$$scope*/ ctx[9])
						: get_slot_changes(before_inner_slot_template, /*$$scope*/ ctx[9], dirty, get_before_inner_slot_changes),
			...
			if (after_inner_slot) {
				if (after_inner_slot.p && (!current || dirty & /*$$scope*/ 512)) {
					update_slot_base(
						...
						!current
						? get_all_dirty_from_scope(/*$$scope*/ ctx[9])
						: get_slot_changes(after_inner_slot_template, /*$$scope*/ ctx[9], dirty, get_after_inner_slot_changes),
...
function instance($$self, $$props, $$invalidate) {
	let innerClasses;
	const omit_props_names = ["classes","noShadow","noHairline","inner","innerClass","innerClassName"];
