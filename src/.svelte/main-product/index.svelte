...
export let review_stars;
  ...
  export let product;
  export let product$options_with_values; 
product.options_with_values = product$options_with_values;

  let section = {};
  export let section$settings; 
section.settings = section$settings;
  export let product$selected_or_first_available_variant; 
  ...
  <div class="pt-6">
    ...
    <div class="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
      <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
        <ImageGallery    review_stars={review_stars} score={score} reviews_count={reviews_count} product={product} inputWidth={inputWidth} breadcrumbs={breadcrumbs} breadcrumbs_size={breadcrumbs_size} price_formatted={price_formatted}  product$options_with_values={product$options_with_values} section$settings={section$settings} product$selected_or_first_available_variant={product$selected_or_first_available_variant}  form_props_f58d08b6b={form_props_f58d08b6b} form_inputs_f58d08b6b={form_inputs_f58d08b6b}  rawinclude_f5b8cf1c={rawinclude_f5b8cf1c} lec={lec} />
      ...
      <div class="mt-4 lg:mt-0 lg:row-span-3">
        ...
        <Reviews    review_stars={review_stars} score={score} reviews_count={reviews_count} product={product} inputWidth={inputWidth} breadcrumbs={breadcrumbs} breadcrumbs_size={breadcrumbs_size} price_formatted={price_formatted}  product$options_with_values={product$options_with_values} section$settings={section$settings} product$selected_or_first_available_variant={product$selected_or_first_available_variant}  form_props_f58d08b6b={form_props_f58d08b6b} form_inputs_f58d08b6b={form_inputs_f58d08b6b}  rawinclude_f5b8cf1c={rawinclude_f5b8cf1c} lec={lec} />
...
{@const forloop = {
  ...
  index: index + 1,
  index0: index,
  last: index === ( product.options_with_values).length - 1,
  rindex: ( product.options_with_values).length - index,
  rindex0: ( product.options_with_values).length - index - 1,
  length: ( product.options_with_values).length,
} }
              <!-- {% comment %} -->
...
{@const forloop = {
  ...
  rindex: ( option.values).length - index,
  rindex0: ( option.values).length - index - 1,
  ...
  length: ( option.values).length,
          ...
          <div class="mt-10">
            <label class="text-base"> Quantity </label>
              <QuantityBox  bind:quantity   review_stars={review_stars} score={score} reviews_count={reviews_count} product={product} inputWidth={inputWidth} breadcrumbs={breadcrumbs} breadcrumbs_size={breadcrumbs_size} price_formatted={price_formatted}  product$options_with_values={product$options_with_values} section$settings={section$settings} product$selected_or_first_available_variant={product$selected_or_first_available_variant}  form_props_f58d08b6b={form_props_f58d08b6b} form_inputs_f58d08b6b={form_inputs_f58d08b6b}  rawinclude_f5b8cf1c={rawinclude_f5b8cf1c} lec={lec} />
          <div>
      ...
      <div class="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
        ...
        <div>
          ...
          <div class="space-y-6">
            <p class="text-base text-gray-900"> {@html product.description || ''}</p>
          </div>
        </div>
